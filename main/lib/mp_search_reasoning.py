...
class MotionPrimitiveSearch:
    def __init__(self, scenario: Scenario, car_dimensions: CarDimensions, mps: Dict[str, MotionPrimitive],
        ...
        self._wh_ego_list = wh_ego if wh_ego else [0.4, 0.0, 0.4]
        self._wh_policy_list = wh_policy if wh_policy else [0.4, 0.4, 0.0]
        self._wh_rUser1_list = wh_rUser1 if wh_rUser1 else [0.2, 0.6, 0.6]
